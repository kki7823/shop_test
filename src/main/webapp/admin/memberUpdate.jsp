            ...
            <td align="center" bgcolor="#ffffcc">
                <table width="95%" align="center" bgcolor="#ffff99" border="1">
                    <tr align="center" bgcolor="#996600">
                        <td colspan="3"><font class="#ffffff"><b><%=mBean.getName()%>
                            회원님의 정보를 수정 합니다.
                        </b></font></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>패스워드</td>
                        <td><input name="pwd" value="<%=mBean.getId()%>"></td>
                    </tr>
                    <tr>
                        <td>이름</td>
                        <td><input name="pwd" value="<%=mBean.getName()%>"></td>
                    </tr>
                    <tr>
                        <td>성별</td>
                        <td>남<input type="radio" name="gender"
                                    value="1" <%=mBean.getGender().equals("1")?"checked":""%>>
                            여<input type="radio" name="gender"
                                    value="2" <%=mBean.getGender().equals("2")?"checked":""%>>
                        </td>
                    </tr>
                    <tr>
                        <td>이메일</td>
                    ...
                    <tr>
                        ...
                        <td><input name="birthday"
                                   value="<%=mBean.getBirthday()%>"></td>
                    </tr>
                    <tr>
                        <td>우편번호</td>
                        <td><input name="zipcode"
                                   value="<%=mBean.getZipcode()%>">
